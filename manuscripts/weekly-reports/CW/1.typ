...
#title[Cannon Whitney's Report - 1/22/2026]

= Time Dedicated to the Project
I spent approximately 9 hours this week working on planning out the project.

= Contribution to the Project Development Process
I spent most of my time coordinating with the team about the project, including meeting with the advisor and discussing the project scope and requirements. I also spent time researching and setting up the project structure.

= Demonstration of Applied Knowledge
I disscussed with the team about the project scope and requirements, and I was able to apply my knowledge of the project to help the team understand the project and how to proceed. Our advisor was able to help us model the functionality and general architecture of ASTRO.

= Reflection and Lessons Learned
It was difficult to coordinate meeting times with the team and our advisor. We had to find a time that worked for everyone, and I am thankful that everyone was willing to be flexible with their schedules. I hope the team is able to establish a consistent flow so that the project can progress smoothly.